...
The operative registry is R5--R12. The former R1--R4 registry and its inactive future appendix remain provenance under fingerprint `aeb5278f1439cb4667185348012205ed7327db13f6d22703a2e02c00169f233a`; they are superseded and are not executable under this revision. Pending R7--R12 packages are supervisor-direct `zpy` work with ref-local Apply/Unblock allowances; this routing never authorizes live cloud or Git effects.

- GOAL G1: cutoff-safe local products close for all five declared feature families
  - COVERED_BY: R5,R6,R9
  - ACCEPT: five hash-verified `outputs/s0_us_abandon/{feature}/local_run_abandonment_detection_acceptance.json` receipts bind the complete CONUS CSV and detector/merged inventories
- GOAL G2: the California reference remains independent and frozen before prediction reveal
  - COVERED_BY: R7,R8,R11
  - ACCEPT: the attempt-2 `accepted/P2_ACCEPTED.json` and post-freeze gallery preserve the 36-core, eight-legacy, and 12-record blind-secondary boundaries
- GOAL G3: California RF execution is truthful and never exceeds the conditional USD 100 authority
  - COVERED_BY: R10,R11
  - ACCEPT: the retained RF terminal manifest is either fully accepted with checksum/cost evidence or budget/admission-blocked with zero unauthorized operations
- GOAL G4: whole-change acceptance is artifact-backed and externally accounted
  - COVERED_BY: R12
  - ACCEPT: `openspec/changes/ee-california/final-verification.json` reconciles all product, reference, RF, gallery, and external-operation terminal states
...
- [ ] 7.1 Freeze cutoff-safe P1 evidence, 36 core keys, eight legacy keys, and the decision family [#R7]
  ...
  - JOIN: immediate
  - WORKTREE: shared
  - WRITE_SCOPE: function/s2_california_sampling.py,tools/build_s2_california_sampling.py,tools/build_s2_california_review_evidence.py,tests/test_s2_california_2020_sampling_attempt_manifest.py,tests/test_s2_california_sampling.py,tests/test_s2_california_review_evidence_2020.py,data/contracts,outputs/s2_abandon_detect,openspec/changes/ee-california
  - ACCEPT: The new no-overwrite root `D:\xarray\s2_abandon_detect\s2-ca-validation-20260827-window96-t1-v1\sources\landsat_c2_spectral_30m\intermediate\california_sampling\california_2020_reference_attempt_2\` contains exactly 36 core candidates under the 12/9/6/3/6 diagnostic portfolio and all eight separate 2017/2018 legacy-boundary records, with source/alignment hashes, reserve order, blank review templates, and no local/RF/Landsat-model/post-2020 prediction leakage.
  ...
  - TEST: SCOPE: CLI; Run: python -m pytest tests/test_s2_california_2020_sampling_attempt_manifest.py tests/test_s2_california_sampling.py tests/test_s2_california_review_evidence_2020.py --basetemp test_cache/ee-california/pytest/R7 -q
...
- [ ] 8.1 Complete and freeze the independent P2 holdout before any prediction reveal [#R8]
  ...
  - JOIN: immediate
  - WORKTREE: shared
  - WRITE_SCOPE: function/s2_california_sampling.py,function/s2_california_2020_validation.py,function/spectral_abandonment.py,tools/build_s2_california_sampling.py,tools/build_s2_california_review_evidence.py,tests/test_s2_california_review_evidence_2020.py,tests/test_s2_california_2020_validation.py,tests/test_spectral_abandonment.py,outputs/s2_abandon_detect,openspec/changes/ee-california
  ...
  - ACCEPT: `D:\xarray\s2_abandon_detect\s2-ca-validation-20260827-window96-t1-v1\sources\landsat_c2_spectral_30m\intermediate\california_sampling\california_2020_reference_attempt_2\accepted\P2_ACCEPTED.json` binds the decision-family, core, legacy, combined-freeze, review, adjudication, source, coordinate, and projection hashes. No P2 value trains or tunes RF, thresholds, window duration, resolution, features, candidate selection, or replacement selection, and no post-2020 observation mutates a 2020 field.
  - TEST: SCOPE: CLI; Run: python -m pytest tests/test_s2_california_review_evidence_2020.py tests/test_s2_california_2020_validation.py tests/test_spectral_abandonment.py --basetemp test_cache/ee-california/pytest/R8 -q
...
- [ ] 9.1 Materialize and verify all five detector/merged inventories and complete-CONUS CSVs [#R9]
  ...
  - JOIN: immediate
  - WORKTREE: shared
  - WRITE_SCOPE: function/cropland_abandonment.py,function/embedding_pipeline.py,tools/run_prediction_mode_end_to_end.py,tools/build_multiscale_embedding.py,tests/test_cropland_abandonment.py,tests/test_embedding_pipeline.py,tests/test_multiscale_embedding_contract.py,tests/test_mode2_runner_contract.py,data,outputs/s0_us_abandon,openspec/changes/ee-california
  ...
  - TEST: SCOPE: CLI+LOCAL-PRODUCT; Run: python -m pytest tests/test_cropland_abandonment.py tests/test_embedding_pipeline.py tests/test_multiscale_embedding_contract.py tests/test_mode2_runner_contract.py --basetemp test_cache/ee-california/pytest/R9 -q; python tools/run_prediction_mode_end_to_end.py --verify-products-only --scope conus --features 300m_min4 300m_min6 1km_mode_min4 1km_mode_min5 1km_mode_min6
...
- [ ] 10.1 Run the RF canary and conditionally execute full California training under the USD 100 cap [#R10]
  ...
  - JOIN: immediate
  - WORKTREE: shared
  - WRITE_SCOPE: function/s2_cdl_training.py,function/s2_validation_budget.py,function/s2_gee_deployment.py,function/s2_gee_output.py,function/s2_california_execution_gate.py,tools/run_s2_abandonment.py,tests/test_s2_rf_graph.py,tests/test_s2_cdl_training.py,tests/test_s2_validation_budget.py,tests/test_s2_gee_deployment.py,tests/test_s2_gee_output.py,tests/test_s2_california_validation_contract.py,data/contracts,outputs/s2_abandon_detect,openspec/changes/ee-california
  ...
  - ACCEPT: If the budget and all gates pass, the exact full California training manifest executes serially under `D:\xarray\s2_abandon_detect\{run_id}\` with `max_inflight=1`, no automatic retry, immutable attempt prefixes, admission before every unit, and an actual-plus-worst-case-remaining cap check. If they cannot pass, R10 retains a compact `outputs/s2_abandon_detect/manifests/{run_id}_rf_california_training_terminal.json` state of `RF_CALIFORNIA_TRAINING_BLOCKED_BY_BUDGET_OR_ADMISSION` plus unchanged full-run operation inventory; it never claims training complete. Only complete inventory, object, cost, and model-family evidence may emit `RF_CALIFORNIA_TRAINING_ACCEPTED`.
  ...
  - TEST: SCOPE: CLI+LIVE-CONDITIONAL; Run: python -m pytest tests/test_s2_rf_graph.py tests/test_s2_cdl_training.py tests/test_s2_validation_budget.py tests/test_s2_gee_deployment.py tests/test_s2_gee_output.py tests/test_s2_california_validation_contract.py --basetemp test_cache/ee-california/pytest/R10 -q
...
- [ ] 11.1 Evaluate available frozen variants on P2 and build the post-freeze scene gallery [#R11]
  ...
  - JOIN: immediate
  - WORKTREE: shared
  - WRITE_SCOPE: function/s2_california_2020_validation.py,function/spectral_abandonment.py,tools/build_s2_california_review_evidence.py,tools/build_s2_california_landsat_review_curves.py,tests/test_s2_california_2020_validation.py,tests/test_s2_california_review_evidence_2020.py,tests/test_s2_california_landsat_review_curves.py,tests/test_spectral_abandonment.py,outputs/s2_abandon_detect,openspec/changes/ee-california
  ...
  - ACCEPT: A new append-only `D:\xarray\s2_abandon_detect\s2-ca-validation-20260827-window96-t1-v1\sources\landsat_c2_spectral_30m\intermediate\california_sampling\california_2020_reference_attempt_2\post_freeze\{gallery_id}\` binds `P2_ACCEPTED`, combined reference and decision-family hashes, sample keys, model/variant manifests, and media hashes. It covers all 36 core records by default and keeps eight legacy records in a labeled appendix; any smaller predeclared selection is hash-bound and marked nonrepresentative.
  ...
  - TEST: SCOPE: CLI; Run: python -m pytest tests/test_s2_california_2020_validation.py tests/test_s2_california_review_evidence_2020.py tests/test_s2_california_landsat_review_curves.py tests/test_spectral_abandonment.py --basetemp test_cache/ee-california/pytest/R11 -q
...
- [ ] 12.1 Verify the whole change and publish exact terminal evidence [#R12]
  ...
  - JOIN: immediate
  - WORKTREE: shared
  - WRITE_SCOPE: openspec/changes/ee-california/final-verification.json,openspec/changes/ee-california,outputs/s0_us_abandon,outputs/s2_abandon_detect
  - ACCEPT: `openspec/changes/ee-california/final-verification.json` distinguishes local product acceptance, P2 reference acceptance, RF canary, RF full-training accepted or budget/admission-blocked branch, holdout evaluation, and gallery completion; no command exit, contract-test pass, or cloud-task success substitutes for a required retained artifact.
  ...
  - TEST: SCOPE: CLI; Run: python -m pytest tests/test_cropland_abandonment.py tests/test_process_notebook_contract.py tests/test_mode2_runner_contract.py tests/test_multiscale_embedding_contract.py tests/test_s2_california_sampling.py tests/test_s2_california_review_evidence_2020.py tests/test_s2_california_2020_validation.py tests/test_s2_rf_graph.py tests/test_s2_cdl_training.py tests/test_s2_validation_budget.py tests/test_s2_gee_deployment.py tests/test_s2_gee_output.py tests/test_s2_california_landsat_review_curves.py tests/test_s2_california_validation_contract.py --basetemp test_cache/ee-california/pytest/R12 -q; openspec validate ee-california --strict

# Non-Operative Provenance

The previous R1--R4 active registry and its P3--P7 planning appendix are superseded by this fingerprinted R5--R12 registry. Their exact wording remains recoverable from the prior fingerprint and repository history; it is intentionally not duplicated here and SHALL NOT be parsed into `feature_list.json`.
